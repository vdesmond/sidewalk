...
/**
 * \brief ns3-cosim Gateway that lets a ROS 2 process drive robot mobility and
...
class RobotGateway : public Gateway
{
  public:
    /**
     * \param robots   the robot nodes; index in the container == robot id
     * \param txEnable transmissions requested before this time are ignored
